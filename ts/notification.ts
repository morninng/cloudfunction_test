...
export class Notification{
    ...
    writtendebate2_add_opinion =(event_id, opinion_id, sender_id) =>{
    ...
    writtendebate2_add_generalcomment = (event_id, general_comment_id, sender_id) => {
    ...
    audiotranscriptserver_add_generalcomment = (event_id, general_comment_id, sender_id) => {
    ...
    writtendebate2_add_sentencecomment =(event_id, sentence_id, sender_id) => {
    ...
    audiotranscriptserver_add_sentencecomment =(event_id, sentence_id, sender_id) => {
    ...
    private article_action = (event_id :string , notify_element_id: string , sender_id : string, destination_type : string, notify_element_type : string )=>{
    ...
    private article_action_user(event_id, sender_id, receiver_id, event_title, destination_type, notify_element_type, notify_element_id)
    {
    ...
    private add_notification_data_userfield(receiver_id : string, new_notification_data : NotificatoinData_event_article){
    ...
    private remove_notification_data_userfield(receiver_id, existing_notification_id){
    ...
    private event_participate_user(event_id,  receiver_id, event_notify_data: NotificatoinData_event ){
    ...
    private read_notifications(notification_arr, user_id){
    ...
    private read_notification(notification_key, user_id){
