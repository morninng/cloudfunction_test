...
class Group {
    constructor() {
        this.set_groupevent = (event_id, group_id, event_data) => {
        ...
        this.set_group_member = (group_id, groupmember_obj) => {
        ...
        this.set_group_on_user = (user_id, group_id, user_group_data) => {
        ...
        this.remove_user_from_group = (group_id, user_id) => {
        };
    }
}
exports.Group = Group;
