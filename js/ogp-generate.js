...
class OgpGenerate {
    ...
    retrieve_event_ogp(full_url, event_id) {
        return new Promise((resolve, reject) => {
    ...
    retrieve_audioserverrecognition_ogp(full_url, event_id) {
        return new Promise((resolve, reject) => {
    ...
    retrieve_writtendebatearticle2_ogp(full_url, event_id) {
        return new Promise((resolve, reject) => {
            const event_ref = "/event_related/event/" + event_id;
            firebase_admin.database().ref(event_ref).once("value")
                .then((snapshot) => {
    ...
    retrieve_audio_ogp(full_url, event_id) {
        return new Promise((resolve, reject) => {
...
exports.OgpGenerate = OgpGenerate;
